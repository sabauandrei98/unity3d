...
ifstream f1("cuvinte1ro.txt");
ifstream f2("cuvinte2ro.txt");
ifstream f3("cuvinte3ro.txt");
ofstream g1("cuvinte1ro.out");
ofstream g2("cuvinte2ro.out");
ofstream g3("cuvinte3ro.out");
